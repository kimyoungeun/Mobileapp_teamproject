          ...
          Row(
            children: <Widget>[
              Container(
                ...
                margin: EdgeInsets.only(left: 175, bottom: 50),
                child: FittedBox(
...
//              ),
  ...
  Widget _buildBody(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance.collection('todoList').where('date', isEqualTo: selectedDate.substring(0,10)).snapshots(),
              ...
              body: new TextField(
                ...
                onSubmitted: (val) {
                  ...
                  Firestore.instance.collection("todoList").document(docu)
                      .setData({'name' : val, 'id': userID, 'date': selectedDate.substring(0,10), 'todo': [val], 'done': [], 'notdone': [val]});
                  _addTodoItem(val);
...
class Record {
  ...
  @override
  String toString() => "Record<$name:$id:$date:$todo:$done:$notdone>";
}